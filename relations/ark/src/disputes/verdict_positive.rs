...
mod relation {
    ...
    #[derive(Clone, Debug)]
    struct VerdictPositiveRelation {
        // Private inputs
    ...
    fn generate_constraints() {
        ...
        //-------------------------------------------------
        computed_votes.enforce_cmp(&min_votes, Ordering::Greater, true)?;
        ...
        let limit = FpVar::new_constant(
            ns!(cs, "verdict_value"),
            CircuitField::from(VerdictRelation::Positive as u64),
        )?;
...
mod tests {
    ...
    fn get_circuit_with_full_input() -> VerdictPositiveRelationWithFullInput {
        let votes = vec![1u8, 1u8, 1u8];
    ...
    fn verdict_proving_procedure() {
        let circuit_without_input = VerdictPositiveRelationWithoutInput::new();
        ...
        let circuit_with_public_input: VerdictPositiveRelationWithPublicInput =
